...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('DIRECT_MESSAGE', 'CHANNEL_MENTION', 'MESSAGE_REACTION', 'SERVER_INVITE', 'FRIEND_REQUEST', 'SERVER_JOIN', 'SYSTEM', 'CALL_INCOMING', 'MISSED_CALL');

-- CreateEnum
CREATE TYPE "NotificationEntityType" AS ENUM ('USER', 'SERVER', 'CHANNEL', 'DIRECT_MESSAGE_CHANNEL', 'CHANNEL_MESSAGE', 'DIRECT_MESSAGE');
