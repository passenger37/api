-- PostgreSQL Index Strategy — Phase 3 (Lecture 40.82)
...
CREATE INDEX IF NOT EXISTS "E2eeDeliveryQueue_pending_pickup_idx"
  ON "E2eeDeliveryQueue" ("targetDeviceId", "status", "nextRetryAt")
...
CREATE INDEX IF NOT EXISTS "E2eeEnvelope_pending_pickup_idx"
  ON "E2eeEnvelope" ("recipientDeviceId", "status", "createdAt")
  WHERE "status" = 'PENDING';
...
CREATE INDEX IF NOT EXISTS "BackgroundJob_ready_pickup_idx"
  ON "BackgroundJob" ("queueName", "status", "scheduledAt")
