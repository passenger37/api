...
export const COMMUNITY_REALTIME_EVENTS = {
  ...
  POST_EDITED: 'community:post:edited',
  POST_VOTED: 'community:post:voted',
  POST_BOOKMARKED: 'community:post:bookmarked',
  POST_REPORTED: 'community:post:reported',
  POST_REPORT_RESOLVED: 'community:post:report-resolved',
  POST_MODERATED: 'community:post:moderated',
