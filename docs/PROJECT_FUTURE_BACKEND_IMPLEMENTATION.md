...
40.87 — Database Integration Tests                                                                                       [NEXT/CURRENT]
```
...
Scale / Load                    ████████████████████  load model (40.80) + multi-instance WS (40.81) + DB/query optimisation (40.82) + cache architecture (40.83) + API versioning (40.84) + Swagger hardening (40.85) + contract tests (40.86) done; DB integration tests (40.87) next
