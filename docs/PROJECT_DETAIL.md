...
**Lecture 40.88 — (Redis Integration Tests, next Scale-phase step).** 40.87 is complete.
...
**Next lecture after this: 40.88 (Redis Integration Tests, using isolated test Redis infrastructure).**
