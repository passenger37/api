...
**Lecture 40.97 — (Performance Profiling).** 40.96 is complete; 40.91–40.95 were declared NOT APPLICABLE (no deployment in scope), so the review-style lectures continue with 40.97.
