...
40.85 — OpenAPI/Swagger Hardening  (current)
```
...
API Versioning / Evolution (completed)
        ↓
40.85
OpenAPI/Swagger Hardening [NEXT/CURRENT]
```
